...
<div class="navbar bg shadow-sm">
   <div class="container">
     ...
     <nav class="d-inline-flex mt-md-0 ms-md-auto">
       <a class="me-3 py-2 text-white text-decoration-none" href="#">로그인</a>
       <a class="py-2 text-white text-decoration-none" href="#">회원가입</a>
     </nav>
   </div>
</div>
...
<div class="text-center">
	<a href="#">
		<img src="assets/gorri-removebg.png" class="rounded">
	</a>
</div>
